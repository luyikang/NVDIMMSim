...
#define PLANE_SIZE ((PAGE_SIZE/1024) * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
#define DIE_SIZE ((PAGE_SIZE/1024) * PLANES_PER_DIE * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
#define PACKAGE_SIZE ((PAGE_SIZE/1024) * DIES_PER_PACKAGE * PLANES_PER_DIE * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
#define TOTAL_SIZE ((PAGE_SIZE/1024) * NUM_PACKAGES * DIES_PER_PACKAGE * PLANES_PER_DIE * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
