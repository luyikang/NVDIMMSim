...
#define NV_WORD_SIZE (NV_PAGE_SIZE / WORDS_PER_PAGE)
#define BLOCK_SIZE (NV_PAGE_SIZE * PAGES_PER_BLOCK)
#define PLANE_SIZE ((NV_PAGE_SIZE/1024) * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
#define DIE_SIZE ((NV_PAGE_SIZE/1024) * PLANES_PER_DIE * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
#define PACKAGE_SIZE ((NV_PAGE_SIZE/1024) * DIES_PER_PACKAGE * PLANES_PER_DIE * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
#define TOTAL_SIZE ((NV_PAGE_SIZE/1024) * NUM_PACKAGES * DIES_PER_PACKAGE * PLANES_PER_DIE * BLOCKS_PER_PLANE * PAGES_PER_BLOCK)
