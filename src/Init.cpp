...
bool ENABLE_NV_SAVE;
std::string NVDIMM_SAVE_FILE;
bool ENABLE_NV_RESTORE;
std::string NVDIMM_RESTORE_FILE;
...
namespace NVDSim 
{
	...
	static ConfigMap configMap[] = {
		...
		DEFINE_STRING_PARAM(NVDIMM_SAVE_FILE, DEV_PARAM),
		DEFINE_BOOL_PARAM(ENABLE_NV_RESTORE, DEV_PARAM),
		DEFINE_STRING_PARAM(NVDIMM_RESTORE_FILE, DEV_PARAM),
		...
		DEFINE_UINT_PARAM(NV_PAGE_SIZE,DEV_PARAM),
		DEFINE_UINT_PARAM(DEVICE_CYCLE,DEV_PARAM),
		DEFINE_UINT_PARAM(CHANNEL_CYCLE,DEV_PARAM),
		DEFINE_UINT_PARAM(DEVICE_WIDTH,DEV_PARAM),
		DEFINE_UINT_PARAM(CHANNEL_WIDTH,DEV_PARAM),
